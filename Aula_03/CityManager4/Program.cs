...
namespace CityManager4
{
    ...
    public class Program
    {
        ...
        private IComparer<Building> _compareByTypeAlpha, 
                                    _compareByTypeReverseAlpha;
        ...
        private Program()
        {
            ...
            _compareByTypeAlpha = new CompareByType(true);
            _compareByTypeReverseAlpha = new CompareByType(false);
        }
        ...
        private void SortBuildings()
        {
            switch(ordering)
            {
                ...
                case Ordering.ByTypeAlpha:
                    buildings.Sort(_compareByTypeAlpha);
                    break;

                case Ordering.ByTypeReverseAlpha:
                    buildings.Sort(_compareByTypeReverseAlpha);
                    break;
            }
        }
